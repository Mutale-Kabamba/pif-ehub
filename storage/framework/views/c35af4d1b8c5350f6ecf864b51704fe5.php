...
<div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:12px; margin-bottom:8px;">
    <h3 style="margin:0;">&#x1F4DD; Live Interview Evaluation &mdash;
        <span style="color:<?php echo e($panelColor); ?>;"><?php echo e($panelLabel); ?></span>
    </h3>
    <span style="background:<?php echo e($panelColor); ?>; color:#fff; font-size:0.8rem; padding:4px 12px; border-radius:20px; font-weight:600;">
        Panelist: <?php echo e($user->panelist_name ?? $user->name); ?>
...
<div class="form-group" style="max-width:500px;">
    <label for="candidate_picker" style="font-weight:600;">Select Candidate from <?php echo e($panelLabel); ?> Roster</label>
    <select id="candidate_picker" class="form-control" style="font-size:1rem;">
        <option value="">-- Choose a Candidate --</option>
        <?php $__currentLoopData = $panelCandidates ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($candidate->id); ?>" data-name="<?php echo e($candidate->name); ?>">
                <?php echo e($candidate->name); ?>

                <?php if($candidate->gender): ?> (<?php echo e($candidate->gender); ?>) <?php endif; ?>
            </option>
...
<div id="eval-form-wrap" style="display:none;">
    ...
    <form action="<?php echo e(route('admin.panel.store')); ?>" method="POST" id="panel-eval-form">
        <?php echo csrf_field(); ?>
