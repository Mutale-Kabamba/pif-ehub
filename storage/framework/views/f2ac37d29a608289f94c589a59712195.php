...
<?php $__env->startSection('title', 'Edit Assessment - ' . $assessment->title); ?>
...
<div class="page-header" style="display: flex; justify-content: space-between; align-items: center;">
    ...
    <div>
        <a href="<?php echo e(route('assessments.show', $assessment->id)); ?>" class="btn" style="background: #e0e0e0; color: #333;">
...
<form action="<?php echo e(route('assessments.update', $assessment->id)); ?>" method="POST" id="assessment-edit-form">
    <?php echo csrf_field(); ?>
    ...
    <div style="background: #fff; border: 1px solid #e0e0e0; border-radius: 8px; padding: 24px; margin-bottom: 24px;">
        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr 1fr; gap: 16px;">
            <div class="form-group">
                ...
                <input type="text" name="title" id="title" class="form-control" value="<?php echo e(old('title', $assessment->title)); ?>" required>
            </div>

            <div class="form-group">
                <label for="type">Assessment Type *</label>
                <select name="type" id="type" class="form-control" required>
                    <option value="interview" <?php echo e(old('type', $assessment->type) == 'interview' ? 'selected' : ''); ?>>Interview</option>
                    <option value="assessment" <?php echo e(old('type', $assessment->type) == 'assessment' ? 'selected' : ''); ?>>Assessment</option>
                    <option value="survey" <?php echo e(old('type', $assessment->type) == 'survey' ? 'selected' : ''); ?>>Survey</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="status" id="status" class="form-control" required>
                    <option value="draft" <?php echo e(old('status', $assessment->status) == 'draft' ? 'selected' : ''); ?>>Draft</option>
                    <option value="active" <?php echo e(old('status', $assessment->status) == 'active' ? 'selected' : ''); ?>>Active</option>
                    <option value="completed" <?php echo e(old('status', $assessment->status) == 'completed' ? 'selected' : ''); ?>>Completed</option>
                </select>
            </div>
        </div>
        ...
        <div class="form-group" style="margin-bottom: 0;">
            ...
            <textarea name="description" id="description" class="form-control" rows="2"><?php echo e(old('description', $assessment->description)); ?></textarea>
        </div>
    </div>
    ...
    <div style="background: #fff; border: 1px solid #e0e0e0; border-radius: 8px; padding: 24px; margin-bottom: 24px;">
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px;">
            <div class="form-group">
                ...
                <input type="number" name="max_panelists" id="max_panelists" class="form-control" value="<?php echo e(old('max_panelists', $assessment->rule?->max_panelists)); ?>" min="1">
            </div>

            <div class="form-group">
                <label for="score_cap">Score Cap</label>
                <input type="number" step="0.01" name="score_cap" id="score_cap" class="form-control" value="<?php echo e(old('score_cap', $assessment->rule?->score_cap)); ?>">
            </div>

            <div class="form-group">
                <label for="passing_threshold">Passing Threshold</label>
                <input type="number" step="0.01" name="passing_threshold" id="passing_threshold" class="form-control" value="<?php echo e(old('passing_threshold', $assessment->rule?->passing_threshold)); ?>">
            </div>
        </div>
    </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
            ...
            <div>
                ...
                <div style="max-height: 220px; overflow-y: auto; border: 1px solid #ddd; padding: 12px; border-radius: 6px; background: #fafafa;">
                    <?php $__currentLoopData = $panelists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pIdx => $panelist): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="panelist-item" style="display: flex; align-items: center; justify-content:space-between; gap: 8px; margin-bottom: 8px; padding-bottom:4px; border-bottom:1px solid #eee;">
                            <label style="display: flex; align-items: center; gap: 8px; margin: 0; font-weight: normal; cursor: pointer; flex:1;">
                                <input type="checkbox" name="panelists[<?php echo e($pIdx); ?>][user_id]" value="<?php echo e($panelist->id); ?>" class="panelist-cb" <?php echo e(in_array($panelist->id, old('panelists', $assignedPanelistIds)) ? 'checked' : ''); ?> style="accent-color: #59B33F;">
                                <span class="panelist-text"><?php echo e($panelist->panelist_name ?: $panelist->name); ?> (<?php echo e($panelist->email); ?>)</span>
                            </label>
                            <select name="panelists[<?php echo e($pIdx); ?>][panel_name]" class="form-control" style="width: 90px; height: 30px; font-size: 0.75rem; padding: 2px 4px;">
                                <option value="A" <?php echo e($panelist->panel == 'A' ? 'selected' : ''); ?>>Panel A</option>
                                <option value="B" <?php echo e($panelist->panel == 'B' ? 'selected' : ''); ?>>Panel B</option>
                                <option value="cover" <?php echo e($panelist->panel == 'cover' ? 'selected' : ''); ?>>Cover</option>
                            </select>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div>
                ...
                <div style="max-height: 220px; overflow-y: auto; border: 1px solid #ddd; padding: 12px; border-radius: 6px; background: #fafafa;">
                    <?php $__currentLoopData = $candidates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cIdx => $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="cand-item" style="display: flex; align-items: center; justify-content:space-between; gap: 8px; margin-bottom: 8px; padding-bottom:4px; border-bottom:1px solid #eee;">
                            <label style="display: flex; align-items: center; gap: 8px; margin: 0; font-weight: normal; cursor: pointer; flex:1;">
                                <input type="checkbox" name="candidates[<?php echo e($cIdx); ?>][candidate_id]" value="<?php echo e($candidate->id); ?>" class="cand-cb" <?php echo e(in_array($candidate->id, old('candidates', $assignedCandidateIds)) ? 'checked' : ''); ?> style="accent-color: #59B33F;">
                                <span class="cand-text"><?php echo e($candidate->name); ?> (<?php echo e($candidate->gender ?: 'N/A'); ?>)</span>
                            </label>
                            <select name="candidates[<?php echo e($cIdx); ?>][panel_name]" class="form-control" style="width: 90px; height: 30px; font-size: 0.75rem; padding: 2px 4px;">
                                <option value="A" <?php echo e($candidate->panel == 'A' ? 'selected' : ''); ?>>Panel A</option>
                                <option value="B" <?php echo e($candidate->panel == 'B' ? 'selected' : ''); ?>>Panel B</option>
                            </select>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const existingQuestions = <?php echo json_encode($assessment->questions, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mukuk\Documents\GitHub\pif-ehub\resources\views/assessments/edit.blade.php ENDPATH**/ ?>